...
## Create graphs and save to PNG
png("plot4.png", width=480, height=480)
par(mfrow = c(2, 2))
plot(global2 ~ date_time, type = "l", ylab = "Global Active Power", 
     xlab = "")
plot(electric$Voltage ~ date_time, type = "l", ylab= "Voltage", xlab= "")
plot(electric$Sub_metering_1 ~ date_time, type = "l", ylab = "Energy sub metering", 
     xlab = "")
...
plot(electric$Global_reactive_power ~ date_time, type = "l", ylab = "Global Reactive Power", xlab= "")
dev.off()